// Copyright (c) 2014 The Nexuscrypto developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("nexuscrypto-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("nexuscrypto-smsg-pow"); // Make this thread recognisable
