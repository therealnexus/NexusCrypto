...
unsigned int nStakeMinAge = 1 * 30 * 60; // 30 minutes
...
const string strMessageMagic = "Nexuscrypto Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Nexuscrypto: check proof-of-stake block signature
...
// nexuscrypto: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nexuscrypto", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This is a great opportunity for the Quad Cities said Pat Miletich";
        CTransaction txNew;
        txNew.nTime = 1412274520;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1412274522;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1063273;
		if(fTestNet)
        {
            block.nNonce   = 1063273;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xee4c328367727dacf3fb5885bf3083763f84cfde25711359abd73400ac3a6a97"));
        block.print();
