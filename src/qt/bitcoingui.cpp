    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("Nexuscrypto"));
    qApp->setStyleSheet("QMainWindow { background:rgb(255,255,255);font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top:15px;padding-bottom:10px;margin:0px; } #spacer { background:rgb(182,133,54);border:none; } #toolbar2 { border:none;width:10px; background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(207,207,207), stop: 1 rgb(207,207,207)); } #toolbar { border:none;height:100%;padding-top:20px; background: rgb(182,133,54); text-align: left; color: white;min-width:200px;max-width:200px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(182,133,54), stop: 1 rgb(182,133,54),stop: 2 rgb(182,133,54));} QToolBar QToolButton { font-family:Century Gothic;padding-left:20px;padding-right:100px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: rgb(182,133,54) } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: rgb(182,133,54); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(207,207,207), stop: 1 rgb(207,207,207)); } QMenuBar { background: rgb(182,133,54); color:white; } QMenuBar::item { font-size:12px;padding-bottom:12px;padding-top:12px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(182,133,54), stop: 1 rgb(182,133,54)); }");
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&Balance"), this);
    overviewAction->setToolTip(tr("Show general balance of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

statisticsAction = new QAction(QIcon(":/icons/statistics"), tr("&Net Status"), this);
    statisticsAction->setToolTip(tr("View statistics"));
    statisticsAction->setCheckable(true);
    tabGroup->addAction(statisticsAction);


    chatAction = new QAction(QIcon(":/icons/social"), tr("&Social Feeds"), this);
    chatAction->setToolTip(tr("View all the Nexuscrypto Social Media"));
    chatAction->setCheckable(true);
    tabGroup->addAction(chatAction);	

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Make a Transfer"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Nexuscrypto address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Get Address"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(QIcon(":/icons/history"), tr("&Tx History"), this);
    ...
    messageAction = new QAction(QIcon(":/icons/message"), tr("&CryptoSMS"), this);
    ...
    explorerAction = new QAction(QIcon(":/icons/block"), tr("&Block Explorer"), this);
    ...
    newsAction = new QAction(QIcon(":/icons/cloud"), tr("&Nexus Site"), this);
    newsAction->setStatusTip(tr("NexusCrypto Services"));
    newsAction->setToolTip(newsAction->statusTip());
    newsAction->setCheckable(true);
    tabGroup->addAction(newsAction);  

    tradeAction = new QAction(QIcon(":/icons/mine"), tr("&IRC Support"), this);
    tradeAction->setStatusTip(tr("Receive Support through IRC Chat"));
    ...
    exchangeAction = new QAction(QIcon(":/icons/ex"), tr("&Exchanging"), this);
    exchangeAction->setStatusTip(tr("Trade NXS in major exchanges"));
...
connect(statisticsAction, SIGNAL(triggered()), this, SLOT(gotoStatisticsPage()));
    ...
    aboutCardAction = new QAction(tr("Nexuscrypto Website"), this);
    aboutCardAction->setToolTip(tr("Go to Nexuscrypto website"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Nexuscrypto"), this);
    aboutAction->setToolTip(tr("Show information about nexuscrypto"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for nexuscrypto"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt Nexuscrypto..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup Nexuscrypto..."), this);
    backupWalletAction->setToolTip(tr("Backup Nexuscrypto to another location"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    unlockWalletAction = new QAction(QIcon(":/icons/lock_open"), tr("&Unlock Nexuscrypto..."), this);
    unlockWalletAction->setToolTip(tr("Unlock Nexuscrypto"));
    lockWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Lock Nexuscrypto"), this);
    lockWalletAction->setToolTip(tr("Lock Nexuscrypto"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("nexuscrypto client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("nexuscrypto client"));
...
{
    QDesktopServices::openUrl(QUrl("http://www.thenexuscrypto.in/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nexuscrypto network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid nexuscrypto address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(tr("Nexuscrypto is <b>encrypted</b> and currently <b>unlocked</b>"));
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("Nexuscrypto is <b>encrypted</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup Nexuscrypto"), saveDir, tr("Nexuscrypto Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save the Nexuscrypto data to the new location."));
        }
    }
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            labelStakingIcon->setToolTip(tr("Not staking because Nexuscrypto is locked"));
        else if (vNodes.empty())
            labelStakingIcon->setToolTip(tr("Not staking because Nexuscrypto is offline"));
        else if (IsInitialBlockDownload())
            labelStakingIcon->setToolTip(tr("Not staking because Nexuscrypto is syncing"));
        else if (!nWeight)
